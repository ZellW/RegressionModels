...
summary(fit_am)$coef
```
Because the p-value is small, the null hypothesis is rejected and it can be determined there is linear correlation between the predictor variable am and mpg. The model summary returns an adjusted \(R^{2}\) explaining only 34% of the variance. 
...
Based on the data analysis provided herin, the following observations can be supported:
